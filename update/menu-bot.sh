...
Isadmin=$(curl -sS https://raw.githubusercontent.com/GH-reyz/IP-Register/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/GH-reyz/IP-Register/main/ipmini | grep $MYIP | awk '{print $3}')
fi
